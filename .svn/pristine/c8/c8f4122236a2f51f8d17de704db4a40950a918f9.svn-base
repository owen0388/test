...
import '../pages/chat/QuickStart/quick_start/quick_start_binding.dart';
import '../pages/chat/QuickStart/quick_start/quick_start_page.dart';
import '../pages/chat/QuickStart/quick_start/quick_start_videopage.dart';
import '../pages/chat/webrtc/meeting_view.dart';
import '../pages/chat/webrtc/meetion_binding.dart';
...
import '../pages/shequ/shequ_binding.dart';
import '../pages/shequ/shequ_view.dart';
...
class AppPages {
  static final routes = <GetPage>[
    ...
    GetPage(
      name: AppRoutes.MY_VIDEO,
      page: () => QuickStartPage(),
      binding: quickStartBinding(),
    ),
    GetPage(
      name: AppRoutes.MY_VIDEOEXT,
      page: () => QuickStartVideoPage(),
      binding: quickStartBinding(),
    ),
    GetPage(
      name: AppRoutes.MY_WEBRTC,
      page: () => MeetingView(),
      binding: MeetingBinding(),
    ),
    GetPage(
      name: AppRoutes.MY_SHEQU,
      page: () => SheQuPage(),
      binding: SheQuBinding(),
    ),
  ];
}
