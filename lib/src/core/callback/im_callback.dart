...
class IMCallback {
  ...
  ///  获取朋友圈未读消息
  var wechatMomentsEventSubject = PublishSubject<int>();
  ...
  void recvNewMessage(Message msg) {
    ...
    //   var str = jsonDecode(msg.content!);
    //   print("@@@@@@@@");
    //   print(str["data"]);
    //   print(str["extension"]);
    //   print(str["description"]);
    //   Timer(Duration(seconds: 2), () {
    //     AppNavigator.OpenQuickStartVideoPage(str["data"],str["extension"],"jieshou");//跳转界面
    //   });
    // }
  }
  ...
  void totalwechatMomentsCountChanged(int count) {
    initLogic.showBadge(count);
    wechatMomentsEventSubject.addSafely(count);
  }
