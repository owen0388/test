...
class AppNavigator {
  ...
  static void startMineSeting() {
    Get.toNamed(AppRoutes.MIND_SETING);
  }

  static void startMyPublish() {
    Get.toNamed(AppRoutes.MY_PUBLISH);
  }


  // ///音频通话
  // static void OpenQuickStartPage() {
  //   Get.toNamed(AppRoutes.MY_VIDEO);
  // }
  ///视频通话
  static void OpenQuickStartPage(String mydata,String myextension,String mydescription) {
    Get.toNamed(
      AppRoutes.MY_VIDEO,
      arguments: {
        "data" : mydata,
  ...
  ///视频通话
  // static void OpenQuickStartVideoPage() {
  //   Get.toNamed(AppRoutes.MY_VIDEOEXT);
  // }

  ///视频通话
  static void OpenQuickStartVideoPage(String mydata,String myextension,String mydescription) {
    Get.toNamed(
      AppRoutes.MY_VIDEOEXT,
      arguments: {
        "data" : mydata,
        "extension" : myextension,
        "description" : mydescription,
  ...
  ///webrtc
  static void startMyWebRtc() {
    Get.toNamed(AppRoutes.MY_WEBRTC);
  }


  ///群聊社区
  static void startSheQuPage() {
    Get.toNamed(AppRoutes.MY_SHEQU);
  }
}
