...
class HomeLogic extends GetxController {
  ...
  /// 获取朋友圈消息未读数
  void getwechatMomentsMsgCount() {
    OpenIM.iMManager.workMomentsManager.getWorkMomentsUnReadCount().then((wechacount) {
      wechatMoments.value = wechacount;
    });
  }
  ...
  void onInit() {
    ...
    imLogic.wechatMomentsEventSubject.listen((value) {
      wechatMoments.value = value;
    });
