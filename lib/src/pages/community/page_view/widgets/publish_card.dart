...
class PublishCard extends StatelessWidget {
  PublishCard(this.item, {Key? key}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style:
                            TextStyle(color: WcaoTheme.secondary, fontSize: 12),
                      ),
                    ),
            ...
            _isMyselfID ? GuanZhuWidge() : GuanZhuWidge_1()
          ],
        ),
      ),
    );
        ...
        picList.add(
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              image: DecorationImage(
                  image: NetworkImage(picList1[0]), fit: BoxFit.cover),
  ...
  ///添加图片
  List<Widget> addPictureForWarp(
      List temList, List temList2, BuildContext context) {
    List<Container> picListForWarp = [];
    // print("RRRRRRRRRRRRRRRRRRRR");
    //print(temList);

    for (var i = 0; i < temList.length; i++) {
      picListForWarp.add(Container(
        child: GestureDetector(onTap: () {
          // print("11111");
          showBottomSheet(
              context: context, builder: (ctx) => checkPicPage(temList2, i));
        }),
        width: 80, //容器的宽高
        height: 80, //容器的宽高
        decoration: BoxDecoration(
          ...
          color: Colors.white,
          image: DecorationImage(
              image: NetworkImage(temList[i]),
              fit: BoxFit.cover), //图片fit 适应容器大小
          //border: Border.all(color: Colors.cyan, width: 1), // 设置边框
          borderRadius: BorderRadius.all(Radius.circular(5)), // 设置正圆角 0为直角
        ),
      ));
  ...
  Column commentList() {
    return Column(
      children: [
        Container(height: 5),
        Container(
          child: Text("${item["comments"].length.toString()}条评论",
              style: TextStyle(
                fontSize: 16.0,
